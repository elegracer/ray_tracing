...
const std::vector<SceneRegistryEntry> kSceneRegistry {
    {SceneMetadata {"bouncing_spheres", "Bouncing Spheres", 500, true, false}, &make_bouncing_spheres_scene},
    {SceneMetadata {"checkered_spheres", "Checkered Spheres", 500, true, false}, &make_checkered_spheres_scene},
    {SceneMetadata {"earth_sphere", "Earth Sphere", 500, true, false}, &make_earth_sphere_scene},
    {SceneMetadata {"perlin_spheres", "Perlin Spheres", 500, true, false}, &make_perlin_spheres_scene},
    {SceneMetadata {"quads", "Quads", 500, true, false}, &make_quads_scene},
    {SceneMetadata {"simple_light", "Simple Light", 500, true, false}, &make_simple_light_scene},
    {SceneMetadata {"cornell_smoke", "Cornell Smoke", 500, true, false}, &make_cornell_smoke_scene},
    {SceneMetadata {"cornell_smoke_extreme", "Cornell Smoke Extreme", 10000, true, false}, &make_cornell_smoke_scene},
    {SceneMetadata {"cornell_box", "Cornell Box", 1000, true, false}, &make_cornell_box_scene},
    {SceneMetadata {"cornell_box_extreme", "Cornell Box Extreme", 10000, true, false}, &make_cornell_box_scene},
    {SceneMetadata {"cornell_box_and_sphere", "Cornell Box And Sphere", 1000, true, false}, &make_cornell_box_and_sphere_scene},
    {SceneMetadata {"cornell_box_and_sphere_extreme", "Cornell Box And Sphere Extreme", 10000, true, false},
        &make_cornell_box_and_sphere_scene},
    {SceneMetadata {"rttnw_final_scene", "RTTNW Final Scene", 500, true, false}, &make_rttnw_final_scene},
    {SceneMetadata {"rttnw_final_scene_extreme", "RTTNW Final Scene Extreme", 10000, true, false}, &make_rttnw_final_scene},
