...
// TODO: Move this sample back to full standalone application -- no SUTIL, independent cmake build, etc
...
void configureCamera( sutil::Camera& cam, const uint32_t width, const uint32_t height )
{
    ...
    cam.setFovY( 60.0f );
    cam.setAspectRatio( static_cast<float>( width ) / (2.0f*static_cast<float>( height ) ) );
}
...
int main( int argc, char* argv[] )
{
    ...
    try
    {
        ...
        OptixPipelineCompileOptions pipeline_compile_options = {};
        {
            ...
            size_t      inputSize = 0;
            const char* input = sutil::getInputData( OPTIX_SAMPLE_NAME, OPTIX_SAMPLE_DIR, "optixConsole.cu", inputSize );
        ...
        //
        {
            ...
            CUDA_CHECK( cudaMemcpy( pixels.data(), d_pixels, width * height * sizeof( uchar4 ), cudaMemcpyDeviceToHost ) );
