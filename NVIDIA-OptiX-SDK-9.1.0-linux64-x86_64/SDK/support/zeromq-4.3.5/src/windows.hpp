...
// OptiX patch: include afunix.h early on modern Windows SDKs to get sockaddr_un
// and avoid redefinition conflicts with ZeroMQ's fallback.
#if defined(ZMQ_HAVE_IPC) && _WIN32_WINNT >= 0x0A00
#include <afunix.h>
...
//  Fix #3949.
#if defined(ZMQ_HAVE_IPC) && !defined(ZMQ_HAVE_STRUCT_SOCKADDR_UN) && !defined(_AFUNIX_)
struct sockaddr_un
{
