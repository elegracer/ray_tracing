...
int main( int argc, char* argv[] )
{
    ...
    try
    {
        ...
        OptixPipeline pipeline = nullptr;
        {
            ...
            OPTIX_CHECK( optixPipelineSetStackSizeFromCallDepths( pipeline, pipeline_link_options.maxTraceDepth,
                                                                  max_cc_depth, max_dc_depth_state,
                                                                  max_dc_depth_traversal, max_traversal_depth ) );
        }
